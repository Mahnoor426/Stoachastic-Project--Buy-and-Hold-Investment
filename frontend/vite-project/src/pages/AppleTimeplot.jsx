...
export default function ApplePlotTime() {
  ...
  const plotKDE = async (model) => {
    try {
      const response = await fetch(`http://localhost:5002/plot-price-time?model=${model}`);
  ...
  return (
    <div className="page-container">
      ...
      <div className="main-content">
        {/* <h1 className="main-heading">Monte Carlo Simulations for Apple Data</h1> */}
